...
After Version 2 got me to a respectable 200K posts/sec, I wasn’t ready to call it a day. BrandPulse demanded more—closer to that 500K posts/sec target—so I dug deeper. Version 3 wasn’t about small tweaks; it was about tearing into Kafka configs, rethinking bottlenecks, and pushing my setup to the edge. This is where I went from “it works” to “it flies,” hitting around 600k posts/sec with a mix of hustle and hard-earned lessons.
...
## Next Up
600k posts/sec was a milestone, but 500K was the prize. Version 4 ([v4](./v4)) tackled serialization and network bottlenecks head-on—check it out for the next leap.
