...
With Version 3 dialed up to a solid 600K+ posts/sec after some late tweaks, I was riding high. BrandPulse’s 500K/sec goal was in the bag, but I couldn’t resist pushing further—could I hit 1M+ and really show off? Version 4 was my all-in bet: auto-scaling workers, hardcore Kafka configs, and a setup built to dominate. The result? A wild ride that peaked high but crashed hard, proving v3’s 600K+ was the real champ. Here’s the tale.

## The Drive
V3 was a beast at 600K+ posts/sec—way past the 500K target—but I saw a chance to double down. Theoretical maxes hinted at millions, so I aimed for 1M+ sustained throughput. I’d need dynamic scaling, tighter error handling, and a system that could flex under pressure. Problem was, I was still on one machine, and v3 was already flexing its muscles. This was about testing the ceiling—of the hardware and my grit.
