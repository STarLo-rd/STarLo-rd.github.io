...
<div class="resume-page">
  <div class="resume">
    <header class="resume-header">
      ...
      <h1>Mohanpathi S</h1>
      <p class="title">Tech-Agnostic Engineer</p>
    </header>
    ...
    <section class="summary">
      <h2>Summary</h2>
      <p>Tech-agnostic engineer with over 2 years of experience in full-stack web application development at scale. Adept at gathering requirements, collaborating with cross-functional teams, and delivering efficient solutions for startups.</p>
    </section>
    <section class="skills">
      <h2>Skills</h2>
      <ul class="skills-list">
        <li><strong>Programming Languages:</strong> JavaScript, TypeScript, Python, Go, Solidity</li>
        <li><strong>Front-end:</strong> React, Redux, Angular, HTML5, CSS3, Tailwind CSS, Shadcn UI, Responsive Design, PWAs</li>
        <li><strong>Back-end:</strong> Node.js, Express.js, REST APIs, Django, MongoDB, MySQL, GraphQL, AWS DynamoDB, Firebase</li>
        <li><strong>Cloud & DevOps:</strong> AWS, CI/CD, Docker</li>
        <li><strong>Tools & Libraries:</strong> Git, Redis, Payload CMS, HD Keys, Apache Kafka, Pinecone, Jest, Swagger</li>
        <li><strong>Architecture:</strong> Microservices, Event-driven, Serverless</li>
      </ul>
    </section>
    ...
    <section class="projects">
      ...
      <div class="project-item">
        <h3>Attestify</h3>
        <p>Developed a TypeScript SDK for digital payment commitments using HD wallets and cryptographic attestations per BAFT DLPC protocols, with secure signature verification.</p>
      </div>
      <div class="project-item">
        <h3>Chainly</h3>
        <p>Built a Workflow Orchestration SDK to automate complex workflows, manage dependencies, and enable real-time tracking for streamlined execution.</p>
      </div>
    </section>
    <section class="education">
      ...
      <div class="timeline">
        <div class="education-item">
          ...
          <p>Kumaraguru College of Technology, India • 2022 - 2024</p>
          <ul>
            <li>Graduated with First Class Honours (CGPA: 8.8/10).</li>
            <li>Received the Mahatma Gandhi Award twice; served as Technical Ambassador.</li>
          </ul>
        </div>
        <div class="education-item">
          <h3>Bachelor of Computer Application</h3>
          <p>PSG College of Arts and Science, India • 2019 - 2022</p>
          <ul>
            <li>Graduated with First Class Distinction (CGPA: 8.7/10); served as Department Secretary.</li>
          </ul>
        </div>
      </div>
    </section>
